            ...
            <form action="agregar_gasto.php" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date-time local" class="form-control" id="fecha" name="fecha" value="<?php echo $fecha_actual_hora_actual; ?>" required>
                    </div>
                    <input type="hidden" name="categoriaIngreso" value="Gastos">
                </div>
