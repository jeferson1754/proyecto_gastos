...
<body>
    ...
    if ($id) {
        $sql = "SELECT g.ID, d.Detalle AS Descripcion, g.Valor, g.ID_Categoria_Gastos, 
                       c.Nombre as categoria, g.Fecha, c.Categoria_Padre as tipo, g.Fuente_Dinero as metodo_pago, g.id_medio_pago
                FROM gastos g
                            ...
                            <div class="contenedor-logica-gastos">
                                ...
                                <div class="mb-4 p-4 border rounded bg-light shadow-sm contenedor-medios">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-4">
                                            <label class="w-100">
                                                <input type="radio" name="medio_pago" value="1" class="radio-medio-pago" <?php echo ($resultado['id_medio_pago'] == 1) ? 'checked' : ''; ?>>
                                        ...
                                        <div class="col-4">
                                            <label class="w-100">
                                                <input type="radio" name="medio_pago" value="2" class="radio-medio-pago" <?php echo ($resultado['id_medio_pago'] == 2) ? 'checked' : ''; ?>>
                                                <div class="medio-pago-box">
                                        ...
                                        <div class="col-4">
                                            <label class="w-100">
                                                <input type="radio" name="medio_pago" value="3" class="radio-medio-pago" <?php echo ($resultado['id_medio_pago'] == 3) ? 'checked' : ''; ?>>
                                                <div class="medio-pago-box">
