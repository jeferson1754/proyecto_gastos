...
<body>
    <div class="container">
        ...
        <?php
        $gastos_restante = $gastos - $total_gastos_real;
        $ocio_restante = $ocio - $total_ocio_real;
        $ahorros_restante = $ahorro - $total_ahorros_real;

        $color_gastos_detalles = obtenerColor($gastos, $total_gastos_real);
        $color_ocio_detalles = obtenerColor($ocio, $total_ocio_real);
        $color_ahorros_detalles = obtenerColor($ahorro, $total_ahorros_real);
